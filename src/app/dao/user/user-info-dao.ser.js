...
(function () {
    ...
    function userInfoDao(conn,$http) {
        ...
        function schoolSet(data) {
            vm.userInfoData.school=data;
            vm.userInfoData.hasValue=true;
        }
        ...
        function schoolInfoSet(id,sid,name) {
            ...
            vm.userInfoData.hasValue=true;
            console.log(vm.userInfoData.districtId.type);
        }
        ...
        //前端保存用户头像
        function imageFileSet(result) {
            vm.userInfoData.imgSrc=result;
           // vm.userInfoData.portrait=result;
            //调用将头像保存至后端的函数
        ...
        //后端保存用户头像
        function savePhoto(img,callback) {
            conn.get(BASE_URL+'/updatePhoto',{'photo':img},callback);
        }
