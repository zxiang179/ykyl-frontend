...
(function () {
    ...
    function testPageCtrl(testPageDao, testAnswerDao, $window, $routeParams, $location, $timeout, $interval) {
        ...
        function requestFirstQuestion() {
            ...
            vm.currentQuestionBuffNum = storage.getItem('currentQuestionBuffNum') != null ? Number(storage.getItem('currentQuestionBuffNum')) : 0;
        ...
        function refreshCurrentQuestion() {
            ...
            console.log(vm.firstQuestionId)
            console.log(vm.lastQuestionId)
            console.log(vm.currentQuestionBuffNum)
            ...
            vm.currentQuestionAbsNum = vm.currentQuestion.uirelativeId;
            vm.currentQuestionType = vm.currentQuestion.questionType;
            // 边界判断
            if (vm.currentQuestionBuffNum === vm.firstQuestionId) {
                vm.previousBox = true;
            } else if (vm.currentQuestionBuffNum === (vm.lastQuestionId - 1)) {
                vm.laterBox = true;
            } else {
        ...
        function jumpNextPage(i) {
            if (vm.currentQuestionBuffNum < vm.lastQuestionId) {
        ...
        function submitTest() {
            ...
            testAnswerDao.postAnswer(vm.requestParams.type, '[' + JSON.stringify(tmessage) + ']', function (response) {
