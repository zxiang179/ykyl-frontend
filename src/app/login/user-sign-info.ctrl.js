...
(function () {
    ...
    ykylLoginHome.controller('UserSignInfoCtrl',['$location','userInfoDao',UserSignInfoCtrl]);
    function UserSignInfoCtrl($location,userInfoDao) {
        var vm = this;
        ...
        vm.schoolName = vm.userInfoData.school;
        if (vm.schoolName == '') {
            vm.showSchool = false;
        } else {
            vm.showSchool = true;
